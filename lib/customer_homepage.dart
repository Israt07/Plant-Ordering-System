                        ...
                        child: Card(
                          ...
                          child: ListTile(
                            ...
                            leading: ClipRRect(
                              ...
                              child: Image.network(
                                'http://192.168.0.107/plant/uploads/${item.plant.plantimagename}',
                                width: 60.0,
                                height: 60.0,
                                fit: BoxFit.cover,
                              ),
        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              borderRadius: BorderRadius.circular(8.0),
              child: Image.network(
                'http://192.168.0.107/plant/uploads/${plant.plantimagename}',
          ...
          child: Column(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.network(
                  'http://192.168.0.107/plant/uploads/${widget.plant.plantimagename}', // Corrected field name
                  width: double.infinity,
                  height: 200.0,
                  fit: BoxFit.cover,
                ),
